...
for url in webpages:
    ...
    if response.status_code == 200:
        ...
        title = soup.find("p", class_="StyledTypography-VDS__sc-5k55co-0 cKLDUQ StyledBody-VDS__sc-1s1yqd8-0 gjyxKS")
        description = soup.find_next("p", class_="StyledTypography-VDS__sc-5k55co-0 hRAXYu StyledBody-VDS__sc-1s1yqd8-0 gjyxKS")
